...
import top.dolphin.connector.http.HttpRequestLine;
import top.dolphin.connector.http.HttpResponse;
import top.dolphin.connector.http.SocketInputStream;
import top.dolphin.utils.RequestUtil;
import top.dolphin.utils.StringManager;
 ...
 * Time 2018/2/28 15:37
 * Email cyanqi.guan@gmail.com
 * description
 *    core processor to handle request and send servlet processor or static resource processor
 */
public class HttpProcessor {
    ...
    protected StringManager sm =
            StringManager.getManager("top.dolphin.connector.http");
